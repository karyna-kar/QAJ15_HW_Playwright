...
test.describe('Test Get /objects: Test with empty list of objects', () => {
...
test.describe('Test Get /objects: Tests with not empty list of objects', () => {
  ...
  test('GET /objects: check request with several ids parameters', async ({ restfulControllerAuthorizedUser }) => {
    const response = await restfulControllerAuthorizedUser.getObjects(createdIds);
